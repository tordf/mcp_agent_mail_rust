...
BUILD_OUTPUT="$(e2e_run_cargo check -p mcp-agent-mail-server --lib 2>&1)" || true
BUILD_RC=$?
...
SNAP_OUTPUT="$(e2e_run_cargo test -p mcp-agent-mail-server --lib -- tui_theme::tests::snapshot 2>&1)" || true
SNAP_RC=$?
...
BUDGET_OUTPUT="$(e2e_run_cargo test -p mcp-agent-mail-server --lib -- tui_theme::tests::budget 2>&1)" || true
BUDGET_RC=$?
...
DASH_OUTPUT="$(e2e_run_cargo test -p mcp-agent-mail-server --lib -- tui_screens::dashboard::tests 2>&1)" || true
DASH_RC=$?
...
MSG_OUTPUT="$(e2e_run_cargo test -p mcp-agent-mail-server --lib -- tui_screens::messages::tests 2>&1)" || true
MSG_RC=$?
...
THR_OUTPUT="$(e2e_run_cargo test -p mcp-agent-mail-server --lib -- tui_screens::threads::tests 2>&1)" || true
THR_RC=$?
...
SEARCH_OUTPUT="$(e2e_run_cargo test -p mcp-agent-mail-server --lib -- tui_screens::search::tests 2>&1)" || true
SEARCH_RC=$?
...
WCAG_OUTPUT="$(e2e_run_cargo test -p mcp-agent-mail-server --lib -- tui_theme::tests::named_themes_selection_contrast 2>&1)" || true
WCAG_RC=$?
...
TM_OUTPUT="$(e2e_run_cargo test -p mcp-agent-mail-server --lib -- tui_screens::tool_metrics::tests 2>&1)" || true
TM_RC=$?
...
AT_OUTPUT="$(e2e_run_cargo test -p mcp-agent-mail-server --lib -- tui_screens::analytics::tests tui_screens::timeline::tests 2>&1)" || true
AT_RC=$?
...
RES_OUTPUT="$(e2e_run_cargo test -p mcp-agent-mail-server --lib -- tui_screens::reservations::tests 2>&1)" || true
RES_RC=$?
